...
var DaySlot = function (_React$Component) {
  ...
  DaySlot.prototype.render = function render() {
    ...
    if (dayPropGetter) {
      var dayProps = dayPropGetter(max, _dates2.default.isToday(max));
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        style: _extends({}, dStyle, props.style),
        className: (0, _classnames2.default)('rbc-day-slot', dClassName, _dates2.default.isToday(max) && 'rbc-today'),
        now: now,
        min: min,
        max: max,
        step: step
