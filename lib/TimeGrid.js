  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function (date, i) {
      ...
      return _react2.default.createElement(
        ...
        {
          key: i,
          className: (0, _classnames2.default)('rbc-header', dClassName, _dates2.default.isToday(date) && 'rbc-today'),
          style: _extends({}, dStyle, (0, _eventLevels.segStyle)(1, _this5.slots))
        },
