...
var propTypes = {
  ...
  dateCellInner: _propTypes3.elementType,
...
var DateContentRow = function (_React$Component) {
  ...
  DateContentRow.prototype.render = function render() {
    var _props = this.props,
        ...
        dateCellInner = _props.dateCellInner,
        ...
        props = _objectWithoutProperties(_props, ['rtl', 'events', 'range', 'className', 'selectable', 'renderForMeasure', 'startAccessor', 'endAccessor', 'renderHeader', 'minRows', 'maxRows', 'dateCellWrapper', 'dateCellInner', 'eventComponent', 'eventWrapperComponent', 'onSelectStart', 'onSelectEnd', 'dayPropGetter']);
